    ...
    <div class="home-banner">
      <div class="banner-container">
        ...
        <div class="blog-contact animated zoomIn">
          <a class="github circular icon button" data-content="https://github.com/Ourwlsg" data-position="bottom center" style="margin-right: 50px"><i class="github icon"></i></a>
        ...
        <div class="ui wechat-qr flowing popup transition hidden">
          <img src="../../public//images/weixin.png" alt="" class="ui rounded image" style="width: 110px">
        </div>
        <!-- 向下滚动 -->
        ...
        <div class="ui stackable grid">
          ...
          <div class="five wide column" style="left: 34px !important;">
              ...
              <div class="ui my-blue segment">
                <div class="ui fluid vertical menu">
                  <template v-for="(item, index) in typeList">
                    <a class="item" v-if='index<7' :key="item.typeId" @click="toType(item.typeId)">
                      {{ item.typeName }}
            ...
            <div class="ui centered card my-shadow" style="width: 11em">
              <img src="../../public/images/weixin.png" alt="weixin" class="ui rounded image" >
            </div>
          </div>
...
<style>
  ...
  .home-banner {
    ...
    right: 0;
    height: 100vh;
    background: url("../../public/images/welcomeBG.jpg") center center /
    cover no-repeat;
