    ...
    <div class="home-banner">
      <div class="banner-container">
        ...
        <div class="blog-contact animated zoomIn">
          <a class="github circular icon button"
             data-content="https://github.com/Ourwlsg"
             data-position="bottom center"
             style="margin-right: 50px"
             target="_blank"
             href="https://github.com/Ourwlsg"><i class="github icon"></i></a>
          <a class="wechat circular icon button"
             style="margin-right: 50px"><i class="weixin icon"></i></a>
          <a class="qq circular icon button"
             data-content="649975448"
        ...
        <div class="ui stackable grid">
          ...
          <div class="eleven wide column">
            ...
            <!-- <div class="ui top attached segment">
              <div class="ui middle aligned two column grid my-shadow">
                ...
                <div class="right aligned column">
                  <h4 class="ui header m-inline-block m-text"
            ...
            <div class="ui attached  segment my-blog-shadow">
              ...
              <div class="ui padded vertical segment m-padded-tb-large transform-big"
                ...
                <div class="ui middle aligned mobile reversed stackable grid">
                  <div class="eleven wide column"
                    ...
                    <h3 class="ui header"
                        @click="toBlog(item.blogId)">{{item.title}}</h3>
                    <p class="m-text"
                       @click="toBlog(item.blogId)">{{item.description}}</p>
                    <div class="ui grid">
                      <div class="eleven wide column">
                      ...
                      <div class="right aligned five wide column">
                        <a target="_blank"
                           class="ui my-blue basic label m-padded-tiny m-text-thin">{{item.typeName}}</a>
                      </div>
                    </div>
                  </div>
                  <div class="five wide column">
                    <a target="_blank">
                      <img v-bind:src=item.firstPicture
            ...
            <div class="ui segments my-shadow">
              <div class="ui secondary segment">
                <div class="ui two column grid">
                  ...
                  <div class="right aligned column">
                    <a href="/#/types"
                       target="_blank">more <i class="angle double right icon"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div class="ui segments m-margin-top-large my-shadow">
              ...
              <div class="ui my-blue segment">
                <template v-for="(item, index) in tagList">
                  <a target="_blank"
                     class="ui my-blue basic left pointing label m-margin-tb-tiny"
                     v-if='index<15'
                     :key="item.tagId"
                     @click="toTag(item.tagId)">
            ...
            <div class="ui segments m-margin-top-large my-shadow">
              ...
              <div class="ui segment"
                ...
                <a target="_blank"
                   ...
                   style="cursor:pointer;"
                   v-text="item.title"
                   @click="toBlog(item.blogId)"></a>
              </div>
            </div>

            <!--二维码-->
            <h4 class="ui horizontal divider header m-margin-top-large">扫码关注我</h4>
            <div class="ui centered card my-shadow"
                 style="width: 11em">
              <img src="../../public/images/weixin.png"
                   alt="weixin"
                   class="ui rounded image">
  ...
  methods: {
    ...
    message () {
      ...
      if (messageFlag == null) {
        ...
        // Notification({
        //   title: '通知',
        //   message: h('i', { style: 'color: teal' }, 'Welcome！'),
        //   duration: 0
        // })
      }
    ...
    async findPage () {
      ...
      const { data: res } = await this.$http.post('/server/home/findHomePage', param)
      // 解析controller响应回的数据
      if (!res.flag) {
...
.home-banner {
  ...
  right: 0;
  height: 100vh;
  background: url("../../public/images/welcomeBG.jpg") center center / cover
    no-repeat;
